...
public:
    ...
    std::array<unsigned,4> 	IDfds;		/// Directed signed face
    std::array<unsigned,4>  adjTetras;  /// Adjacent tetras for each face (4 x 4B = 16 B)
...
private:
    ...
    /// Implemented in Kernels/Software/Tetra.cpp
